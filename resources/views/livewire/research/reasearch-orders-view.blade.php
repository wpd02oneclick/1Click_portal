            ...
            <div class="btn-list">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#AssignModal">Assign Order</a>
                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#NewTaskModal">New Task</a>
                        @endif
                        <a class="dropdown-item Order-Revision" href="JavaScript:void(0);" data-bs-toggle="modal" data-bs-target="#TaskRevisionModal">Add Revision
                            <input type="hidden" id="Order_ID" value="{{ $Research_Order->Order_ID }}"></a>
                        <a class="dropdown-item" href="{{ route('Research.Edit.Order', ['Order_ID' => $Research_Order->Order_ID]) }}">Edit
                            Order</a>
                        <a class="dropdown-item" href="{{ route('Cancel.Research.Order', ['Order_ID' => $Research_Order->id]) }}">Cancel
                            Order</a>
                        <a class="dropdown-item" href="{{ route('Delete.Research.Order', ['Order_ID' => $Research_Order->id]) }}">Delete
                            Order</a>
                    </div>
                </div>
            </div>
        ...
        <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
            <div class="tab-content">
                            ...
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom" id="files-tables">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ asset($attachment->order_attachment_path) }}" target="_blank" download class="font-weight-semibold fs-14 mt-5">{{ $attachment->File_Name }}
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ asset($attachment->order_attachment_path) }}" class="action-btns1" data-bs-toggle="tooltip" download data-bs-placement="top" title="Download" target="_blank"><i class="feather feather-download   text-success"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
                ...
                <div class="tab-pane" id="tab8">
                    <div class="card-body">
                        <div class="table-responsive" style="min-height: 30vh;">
                            ...
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom" id="responsive-datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item view-assign-task" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ViewTaskModal" data-id="{{ $Task->id }}">View Detail</a>
                                                        <a class="dropdown-item Task_ID" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ChangedWriter">
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}">Change
                                                            Writer</a>
                                                        <a class="dropdown-item Edit-Task Task_ID" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#EditTaskModal">
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                            Edit Task</a>
                                                        <a class="dropdown-item Delete_Task" href="{{ route('Delete.Task', ['Task_ID' => $Task->id]) }}">
                                                            Delete Task
                                                        </a>
                                                        <a class="dropdown-item Task_ID" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#TaskRevisionModal">
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                            Add Revision</a>
                                                        @if (count($Task->revision) > 0)
                                                        <a class="dropdown-item View-Revision" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ViewRevisionModal">View
                                                            Revision
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}"></a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="tab-pane" id="tab10">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-danger mb-4" data-bs-toggle="modal" data-bs-target="#FinalSubmissionModal"> Upload Files
                            </button>
                        </div>
                        <div class="table-responsive">
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom" id="files-tables">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">{{ $loop->iteration }}</td>
                                        <td>
                                            <a href="{{ asset($submission->final_submission_path) }}" target="_blank" download class="font-weight-semibold fs-14 mt-5">{{ $submission->File_Name }}
                                                <span class="text-muted ms-2">(23 KB)</span></a>
                                            <div class="clearfix"></div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ asset($submission->final_submission_path) }}" class="action-btns1" data-bs-toggle="tooltip" download data-bs-placement="top" title="Download" target="_blank"><i class="feather feather-download   text-success"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
                ...
                <div class="tab-pane" id="tab12">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-danger mb-4" data-bs-toggle="modal" data-bs-target="#uploaddraft"> Upload Draft
                            </button>
                        </div>
                        <div class="table-responsive">
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom" id="files-tables">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ asset($attachment->File_Path) }}" target="_blank" download class="font-weight-semibold fs-14 mt-5">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ asset($attachment->File_Path) }}" class="action-btns1" data-bs-toggle="tooltip" download="" data-bs-placement="top" title="" target="_blank" data-bs-original-title="Download" aria-label="Download">
            ...
            <div class="chat border-0">
                <div class="card overflow-hidden mb-0 border-0">
                    ...
                    <div class="card-header">
                        <div class="float-start hidden-xs d-flex ms-2">
                            <div class="img_cont me-3">
                                <img src="{{ !empty($auth_user->basic_info->profile_photo_path) ? asset($auth_user->basic_info->profile_photo_path) : asset('assets/images/users/16.jpg') }}" class="rounded-circle user_img avatar avatar-md" alt="img">
                            </div>
                            <div class="align-items-center mt-2 text-black">
                                <h5 class="mb-0">{{ $auth_user->basic_info->full_name }}</h5>
                                <span class="w-2 h-2 brround bg-success d-inline-block"></span><span class="ms-2 fs-12">Online</span>
                            </div>
                        </div>
                    </div>
                    <!-- action-header end -->
                    ...
                    <div class="card-footer">
                        <form data-action="{{ route('Post.Message') }}" method="POST" enctype="multipart/form-data" id="Chat-Form">
                            @csrf
                            ...
                            <div class="msb-reply-button d-flex mb-3">
                                <div class="input-group">
                                    <input type="text" class="form-control bg-white" placeholder="Typing...." name="Chat_Message" required>
                            ...
                            <div class="msb-reply-button d-flex">
                                <div class="input-group">
                                    <input type="file" class="form-control bg-white" placeholder="Any Attachments" name="files[]" multiple>
                                </div>
                            </div>
                        </form>
                    </div><!-- card-footer end -->
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Education_Level }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Pages_Count }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Word_Count }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Spacing }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Citation_Style }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Sources }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->basic_info->Order_Website }}</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->reference_info->Reference_Code }}</span>
                                </td>
                            </tr>
                            @endif
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->F_DeadLine }}</span>
                                </td>
                            </tr>
                            @endif
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->S_DeadLine }}</span>
                                </td>
                            </tr>
                            @endif
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->T_DeadLine }}</span>
                                </td>
                            </tr>
                            @endif
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold text-info">{{ $Research_Order->basic_info->Order_Status }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ date('F d, Y', strtotime($Research_Order->created_at)) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ date('H:i:s A', strtotime($Research_Order->created_at)) }}</span>
                                </td>
                            </tr>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->client_info->Client_Name }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->client_info->Client_Country }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->client_info->Client_Phone }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->client_info->Client_Email }}</span>
                                </td>
                            </tr>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $task->assign->basic_info->full_name }}</span>
                                </td>
                            </tr>
                            @endforeach
                            @endif
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->authorized_user->basic_info->full_name }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->payment_info->Order_Price }}
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->payment_info->Payment_Status }}
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->payment_info->Rec_Amount }}
                                        &nbsp; {{ $Research_Order->payment_info->Order_Currency }}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $Research_Order->payment_info->Due_Amount }}
                                        &nbsp; {{ $Research_Order->payment_info->Order_Currency }}</span>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="Assign_ID[]" id="Assign_ID" class="form-control select2" data-placeholder="Select Coordinator" multiple required>
            ...
            <form action="{{ route('New.Task') }}" method="POST" class="needs-validation was-validated">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <input type="hidden" name="assign_by" value="{{ Auth::guard('Authorized')->user()->id }}">
                        <input type="hidden" name="total_words" id="Total_Words" value="{{ $total_words !== 0 ? $total_words : (float) Str::replace(['$ ', ','], '', $Research_Order->basic_info->Word_Count) }}">
                        @if ($Research_Order->assign->isEmpty())
                        <input type="hidden" name="Order_ID" value="{{ $Order_ID }}">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label" for="C_Assign_ID">Coordinators</label>
                                <select name="C_Assign_ID[]" id="C_Assign_ID" class="form-control select2" data-placeholder="Select Coordinator" multiple>
                                    <option value="">Select Coordinator</option>
                                    @forelse($Coordinators as $Coordinator)
                                    <option value="{{ $Coordinator->id }}">
                                        {{ $Coordinator->basic_info->full_name }}</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="W_Assign_ID" class="form-control custom-select select2" data-placeholder="Select Writer" aria-required="true" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" placeholder="MM/DD/YYYY" name="DeadLine" type="date" min="0">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="tp3" placeholder="Set time" name="DeadLine_Time" type="time" required>
                            </div><!-- input-group -->
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Total Words</label>
                                <input class="form-control mb-4 is-valid" name="Order_Words" placeholder="Enter Order Words" id="Assign_Words" min="0" type="number" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Due Words</label>
                                <input class="form-control mb-4 is-valid" name="Due_Words" readonly placeholder="Enter Due Amount" type="number" id="Rem_Word">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="TaskRevisionModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Task.Revision') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="summernote" class="form-control mb-4 is-invalid state-invalid" name="Task_Revision" placeholder="Textarea (invalid state)"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine</label>
                            <div class="input-group">
                                ...
                                <input class="form-control Rev-DeadLine" placeholder="MM/DD/YYYY" name="DeadLine" type="date">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine Time</label>
                            <div class="input-group">
                                ...
                                <input class="form-control Rev-Time" placeholder="Set time" name="DeadLine_Time" type="time" required>
                            </div><!-- input-group -->
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
...
<div class="modal fade" id="ViewRevisionModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-block" data-bs-dismiss="modal" aria-label="Close">
                    Close
                </button>
            </div>
        </div>
            ...
            <form action="{{ route('Edit.Task') }}" method="POST" class="needs-validation was-validated">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <input type="hidden" name="order_id" value="{{ $Research_Order->id }}">
                        <input type="hidden" name="assign_by" value="{{ Auth::guard('Authorized')->user()->id }}">
                        <input type="hidden" class="Selected-Total-Words" name="total_words" id="Edit_Total_Words">
                        <input type="hidden" name="Order_ID" value="{{ $Research_Order->Order_ID }}">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Select Writers</label>
                                <select name="W_Assign_ID" class="form-control custom-select select2 Selected-Writer" data-placeholder="Select Writer" aria-required="true" required>
                                    <option value="">Select Writers</option>
                                    @forelse($Writers as $Writer)
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control Selected-Date" placeholder="MM/DD/YYYY" name="DeadLine" type="date" min="0">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine Time</label>
                            <div class="input-group">
                                ...
                                <input class="form-control Selected-Time" placeholder="Set time" name="DeadLine_Time" type="time" required>
                            </div><!-- input-group -->
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Total Words</label>
                                <input class="form-control mb-4 is-valid Selected-Words" name="Order_Words" placeholder="Enter Order Words" id="Edit_Assign_Words" min="0" type="number" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Due Words</label>
                                <input class="form-control mb-4 is-valid Selected-Due-Words" name="Due_Words" readonly placeholder="Enter Due Amount" type="number" id="Edit_Rem_Word">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="FinalSubmissionModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Research.Order.Final.Submit') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
<div class="modal fade" id="TaskRevisionModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Research.Order.Revision') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="form-label" class="form-label"></label>
                                <textarea id="summernote" class="form-control mb-4 is-invalid state-invalid" name="Order_Revision" placeholder="Textarea (invalid state)"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine</label>
                            <div class="input-group">
                                ...
                                <input class="form-control Order-DeadLine" placeholder="MM/DD/YYYY" name="DeadLine" type="date">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine Time</label>
                            <div class="input-group">
                                ...
                                <input class="form-control Order-Time" id="tp3" placeholder="Set time" name="DeadLine_Time" type="time" required>
                            </div><!-- input-group -->
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                        ...
                                        <td>
                                            <div class="btn-list">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item Order-Revision" id="Revision_ID" data-id="{{ $revision->id }}" href="JavaScript:void(0);" data-bs-toggle="modal" data-bs-target="#ViewRevision">View Revision</a>
                                            ...
                                            <div class="btn-list">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item Add-Revision Task_ID" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#TaskRevisionModal">
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                            Add Revision</a>
                                                        @if (count($Task->revision) > 0)
                                                        <a class="dropdown-item View-Revision" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ViewRevisionModal">View
                                                            ...
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}"></a>
                                                        @endif
                                                        <a class="dropdown-item Task_ID" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#TaskCancelWordModal">
                                                            <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                            Cancel Words</a>
                                                    </div>
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control Rev-Time" id="tp3" placeholder="Set time" name="DeadLine_Time" type="time" required>
                            </div><!-- input-group -->
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control Selected-Date" placeholder="MM/DD/YYYY" name="DeadLine" min="0" type="date">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine Time</label>
...
<div class="modal fade" id="TaskCancelWordModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Cancel.Words.Task') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <input type="hidden" name="Order_ID" value="{{ $Research_Order->Order_ID }}">
                        <input type="hidden" name="task_id" class="task-id">
                        <input type="hidden" name="cancel_by" value="{{ Auth::guard('Authorized')->user()->id }}">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="form-label" class="form-label">Any Comments</label>
                                <textarea class="form-control mb-4 is-invalid state-invalid" name="Cancellation_Comments" placeholder="Textarea (invalid state)" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
            <div class="btn-list">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#NewTaskModal">Assign Task</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" placeholder="MM/DD/YYYY" name="DeadLine" min="0" type="date">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine Time</label>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="form-label" class="form-label">Any Comments</label>
                                <textarea class="form-control mb-4 is-invalid state-invalid" name="Cancellation_Comments" placeholder="Textarea (invalid state)"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="#" class="action-btns1 Task_ID w-100" data-bs-toggle="modal" data-bs-placement="top" title="Submit Task" data-bs-target="#TaskSubmissionModal"><i class="feather feather-paperclip text-primary"></i>
                                                    Submit
                                                    <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                </a>
                                                @endif
                                                @if (count($Task->revision) > 0)
                                                <a href="#" class="action-btns1 Task_ID w-100 View-Revision" data-bs-placement="top" title="Submit Task" data-bs-toggle="modal" data-bs-target="#ViewRevisionModal"><i class="feather feather-repeat text-danger"></i>
                                                    Revision
                                                    <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                </a>
                                                @endif
...
<div class="modal fade" id="TaskSubmissionModal">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <form action="{{ route('Task.Submit') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @endif
                                                @if (count($Task->revision) > 0)
                                                <a href="#" class="action-btns1 Task_ID  View-Revision w-100" data-bs-placement="top" title="Submit Task" data-bs-toggle="modal" data-bs-target="#ViewRevisionModal"><i class="feather feather-repeat text-danger"></i>
                                                    Revision
                                                    <input type="hidden" id="Task_ID" value="{{ $Task->id }}">
                                                </a>
                                                @endif
...
<div class="modal fade" id="uploaddraft">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Order.Draft.Submit') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
...
<div class="modal fade" id="SubmitRevision">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{route('Submit.Upload.Order.Revision')}}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
