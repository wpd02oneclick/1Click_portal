...
<head>
    ...
    <!-- Title -->
    <title>1Click Portal | 419 Error!</title>
...
<div class="page error-bg">
    <div class="page-content m-0">
        <div class="container text-center">
            ...
            <h1 class="h3  mb-3 font-weight-semibold">Page Expired!</h1>
            <p class="h5 font-weight-normal mb-7 leading-normal">The page takes too long to send the post request which leads to expiring the CSRF token.</p>
