    ...
    <div class="app-sidebar3">
        ...
        <ul class="side-menu mb-lg-5">
            ...
            <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                    ...
                    <span class="side-menu__label">Manage Orders</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu ">
                    <li class="side-menu-label1"><a href="javascript:void(0);">Manage Orders</a></li>

                    @if ((int) @session()->get('permission')['Research_view'] === 1)
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                @if ((int) @session()->get('permission')['Research_create'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('Research.Create.Order') }}">Create
                                            Order</a></li>
                                @endif
                                @if ((int) @session()->get('permission')['Research_list'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('Research.Orders') }}">All
                                            Orders</a>
                                    </li>
                                @endif
                            </ul>
                    ...
                    @endif
                    @if ((int) @session()->get('permission')['Content_view'] === 1)
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="javascript:void(0);"><span class="sub-side-menu__label">Content
                                                Orders</span><i class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                @if ((int) @session()->get('permission')['Content_create'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('Content.Create.Order') }}">Create
                                            Order</a>
                                    </li>
                                @endif
                                @if ((int) @session()->get('permission')['Content_list'] === 1)
                    ...
                    @endif
                    @if ((int) @session()->get('permission')['Website_view'] === 1)
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                    ...
                    @endif
                    @if((int) @session()->get('permission')['role_id'] === 1 || (int) @session()->get('permission')['role_id'] === 9 || (int) @session()->get('permission')['role_id'] === 10  )
                        <li><a href="{{ route('Clients.List') }}" class="slide-item">Client List</a>
                        </li>
                    @endif
                    @if((int) @session()->get('permission')['Research_view'] === 1 && (int) @session()->get('permission')['Research_list'] === 1)
                        <li><a href="{{ route('Research.Completed.Orders') }}" class="slide-item">Research Completed Orders</a>
                        </li>
                    @endif
                    @if((int) @session()->get('permission')['Content_view'] === 1 && (int) @session()->get('permission')['Content_list'] === 1)
                        <li><a href="{{ route('Content.Completed.Orders') }}" class="slide-item">Content Completed Orders</a>
                        </li>
                    @endif
                </ul>
            </li>

            @if ((int) @session()->get('permission')['role_id'] === 1 || (int) @session()->get('permission')['role_id'] === 2  )
                <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                                     href="javascript:void(0);"> <i
                            class="feather  feather-clipboard sidemenu_icon"></i>
                        <span class="side-menu__label">Permissions</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
            ...
            @if((int) @session()->get('permission')['role_id'] === 1)
                <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                                     href="javascript:void(0);"> <i
                            class="feather  feather-clipboard sidemenu_icon"></i>
            ...
            @endif
            @if ((int) @session()->get('other_permission')['Employee_view'] === 1)
                <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                                     href="javascript:void(0);"> <i
                            class="feather feather-users sidemenu_icon"></i>
                        <span class="side-menu__label">Employees</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0);">Employees</a></li>
                        @if ((int) @session()->get('other_permission')['Employee_list'] === 1)
                            <li><a href="{{ route('All.Employee') }}" class="slide-item">View All</a></li>
                        @endif
                        @if((int) @session()->get('other_permission')['Employee_create'] === 1)
                            <li><a href="{{ route('New.Employee') }}" class="slide-item">Add New</a></li>
                        @endif
                        @if((int) @session()->get('permission')['role_id'] === 1 || (int) @session()->get('permission')['role_id'] === 12 )
                            <li>
                                <a href="{{ route('View.Employee', ['EMP_ID' => $currentUser->EMP_ID]) }}"
                                   class="slide-item">View Profile</a></li>
                        @endif

                    </ul>
                </li>
            @endif
            @if((int) @session()->get('other_permission')['Sales_Performance_view'] === 1 || (int) @session()->get('other_permission')['Writer_Performance_view'] === 1 )
                <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                                     href="javascript:void(0);"> <i
                            class="feather feather-trending-up sidemenu_icon"></i>
                        <span class="side-menu__label">Performance</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0);">Performance</a></li>
                        @if ((int) @session()->get('other_permission')['Sales_Performance_view'] === 1)
                            <li><a href="javascript:void(0);" class="slide-item">Sales Performance</a></li>
                        @endif
                        @if ((int) @session()->get('other_permission')['Writer_Performance_view'] === 1)
            ...
            @if((int)$currentUser->Role_ID === 1 || (int)$currentUser->Role_ID === 2 || (int)$currentUser->Role_ID === 15)
                <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                                     href="javascript:void(0);"> <i
                            class="feather feather-trending-up sidemenu_icon"></i>
                        <span class="side-menu__label">HR Department</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
            ...
            @if((int) @session()->get('permission')['role_id'] !== 1 && (int) @session()->get('permission')['role_id'] !== 2 && (int) @session()->get('permission')['role_id'] !== 15)
                <li class="slide">
            ...
            @endif
            @if((int) @session()->get('other_permission')['department_view'] === 1 || (int) @session()->get('other_permission')['designation_view'] === 1 || (int) @session()->get('other_permission')['Services_view'] === 1 || (int) @session()->get('other_permission')['Website_view'] === 1 )
                ...
                <li class="slide"><a class="side-menu__item" data-bs-toggle="slide"
                    ...
                    <ul class="slide-menu">
                        ...
                        @if ((int) @session()->get('other_permission')['department_view'] === 1)
                            <li><a href="{{ route('All.Departments') }}" class="slide-item">Departments</a></li>
                        @endif
                        @if ((int) @session()->get('other_permission')['designation_view'] === 1)
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                               href="javascript:void(0);"><span
                                    ...
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                @if ((int) @session()->get('other_permission')['Services_view'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('All.Services') }}">Order Services</a>
                                    </li>
                                @endif
                                @if ((int) @session()->get('other_permission')['Website_view'] === 1)
                                ...
                                @if ((int) @session()->get('other_permission')['Services_view'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('All.Styles') }}">Writing Styles</a>
                                    </li>
                                @endif
                                @if ((int) @session()->get('other_permission')['Services_view'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('All.Voices') }}">Preferred Voices</a>
                                    </li>
                                @endif
                                @if ((int) @session()->get('other_permission')['Services_view'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('All.Industries') }}">Order Industries</a>
                                    </li>
                                @endif
                                @if ((int) @session()->get('other_permission')['Services_view'] === 1)
                                    <li><a class="sub-slide-item"
                                           href="{{ route('All.Generics') }}">Order Generics</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide"
                   href="javascript:void(0);"> <i
                        class="feather feather-trending-up sidemenu_icon"></i>
                    <span class="side-menu__label">Manage Attendance</span><i
                        class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    ...
                    @endif
                    <li>
                        <a href="{{ route('My.Attendance', ['User_ID' => $currentUser->id]) }}"
                           class="slide-item">My Attendance</a></li>
                </ul>
            </li>
            @if((int)$currentUser->Role_ID === 1 || (int)$currentUser->Role_ID === 2 || (int)$currentUser->Role_ID === 15)
                <li class="slide">
            ...
            @if ((int) @session()->get('other_permission')['report_view'] === 1)
                <li class="slide">
            ...
            @endif
            @if ((int) @session()->get('other_permission')['Company_policy_view'] === 1)
                <li class="slide">
            ...
            @endif
            @if ((int) @session()->get('other_permission')['Search_order_view'] === 1)
                <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide"
                       href="javascript:void(0);"> <i
                        ...
                        <span class="side-menu__label">Trashed</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                ...
                <li class="slide mb-5">
                    <a class="side-menu__item" data-bs-toggle="slide"
                       href="javascript:void(0);"> <i
                        ...
                        <span class="side-menu__label">Developer</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
